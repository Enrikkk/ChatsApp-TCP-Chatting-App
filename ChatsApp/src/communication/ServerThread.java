...
public class ServerThread extends Thread {
    ...
    // Constructor
    public ServerThread(Semaphore mutex, Semaphore screen, Socket socket, 
    ...
    public void run() {
        try {
            ...
            // The letter "S" is just to signal styling to the client.
            broadcast("S" + msg);
    ...
    public void closeBye() {
        ...
        // Here we put closed to true so that the "close" (for unexpected closing)
